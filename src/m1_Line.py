...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.clones = 0
        self.start_og = start.clone()
        self.end_og = end.clone()
        # --------------------------------------------------------------
        # DONE: 3.
    ...
    def reverse(self):
        ...
        self.start = x
        self.end = y
        reverse = Line(self.start, self.end)
        return reverse
    ...
    def line_plus(self, other_line):
        ...
        Type hints:
          ...
          :rtype: Line:
        """
        big = Line(self.start.plus(other_line.start), self.end.plus(other_line.end))
        return big
        # --------------------------------------------------------------
        # DONE: 9.
        #   a. READ the above specification, including the Example.
    ...
    def line_minus(self, other_line):
        ...
        Type hints:
          ...
          :rtype: Line:
        """
        small = Line(self.start.minus(other_line.start), self.end.minus(other_line.end))
        return small
        # --------------------------------------------------------------
        # DONE: 10.
        #   a. READ the above specification, including the Example.
    ...
    def midpoint(self):
        ...
        Type hints:
          :rtype: Point
        """
        z = self.start.halfway_to(self.end)
        return z
        # --------------------------------------------------------------
        # DONE: 11.
        #   a. READ the above specification, including the Example.
    ...
    def reset(self):
        ...
        """
        self.start = self.start_og
        self.end = self.end_og
        # --------------------------------------------------------------
        # TODO: 13.
        #   a. READ the above specification, including the Example.
        #        ** ASK QUESTIONS AS NEEDED. **
