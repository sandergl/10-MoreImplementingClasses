...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.v_rect = rg.Rectangle(rg.Point(self.h_rect.get_center().x - (letter_thickness / 2), (self.h_rect.get_center().y + height) - (letter_thickness / 2)), rg.Point(self.h_rect.get_center().x + (letter_thickness / 2), self.h_rect.get_upper_right_corner().y))
        # --------------------------------------------------------------
        # DONE: 3.
